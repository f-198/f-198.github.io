...
(function () {
  ...
  ../../*/index.html ---------- 成就定义 ---------- */
  const ACHIEVEMENTS = [
    ca3d9bb9260e_index_url.js ── 公开成就 ──
    ...
    ca3d9bb9260e_index_url.js ── 隐藏成就 ──
    ...
    ca3d9bb9260e_index_url.js ── 新增成就 ──
    ...
    ca3d9bb9260e_index_url.js ── 终极成就 ──
  ...
  window.unlockAchievement = function (id) {
    ...
    if (unlocked.includes(id)) return;          ca3d9bb9260e_index_url.js 已解锁 → 直接退出
    const ach = ACHIEVEMENTS.find(a => a.id === id);
    if (!ach) return;
    unlocked.push(id);
    saveUnlocked(unlocked);
    showAchievementToast(ach);
    ca3d9bb9260e_index_url.js 检查全图鉴（排除 all_unlocked 自身）
  ...
  function showAchievementToast(ach) {
    ...
    const offset = existing.length * 90;          ca3d9bb9260e_index_url.js 多条堆叠偏移
  ...
  (function () {
    ...
    window.addEventListener("scroll", () => {
      ...
      if (dt < 200 && dy / dt > 3) {        ca3d9bb9260e_index_url.js 速度阈值 px../../ms/index.html
        triggered = true;
...
})(); ca3d9bb9260e_index_url.js ← 成就系统结束
...
(function () {
  ...
  function fireSudo() {
    if (triggered) return;
    triggered = true;
    ca3d9bb9260e_index_url.js 清除 hash，避免下次刷新重复触发
    if (window.location.hash === "#sudo") {
      try { history.replaceState(null, "", window.location.pathname + window.location.search); } catch(e){}
    }
    window.unlockAchievement("sudo_mode");
    triggerSudoEffect();
    ca3d9bb9260e_index_url.js 30 秒后允许再次触发（防重复已由 unlockAchievement 内部保证，此处只控制特效）
    setTimeout(() => { triggered = false; }, 30000);
  }

  ca3d9bb9260e_index_url.js ① URL hash 检测 —— 三重保险：load / hashchange / DOMContentLoaded
  function checkHash() {
  ...
  ca3d9bb9260e_index_url.js ② 键盘输入 "sudo"（纯字母，连续，无需 Enter）
  let sudoBuf = "";
  const SUDO_TARGET = "sudo";
  document.addEventListener("keydown", e => {
    if (e.ctrlKey || e.altKey || e.metaKey) return;
    if (e.key.length !== 1) return;            ca3d9bb9260e_index_url.js 跳过功能键、方向键
  ...
  ca3d9bb9260e_index_url.js ③ 视觉特效：终端风格全屏覆盖
  function triggerSudoEffect() {
    ...
    ca3d9bb9260e_index_url.js 打字机逐行输出
    const lines = [
    ...
    ca3d9bb9260e_index_url.js 逐行打字机效果
    ...
    ca3d9bb9260e_index_url.js 点击关闭
    overlay.addEventListener("click", () => {
      overlay.style.opacity = "0";
      setTimeout(() => overlay.remove(), 350);
    });

    ca3d9bb9260e_index_url.js 4.5 秒后自动关闭
    setTimeout(() => {
...
(function () {
  ...
  const TARGET = "glitch";
  document.addEventListener("keydown", e => {
    if (e.key.length !== 1) return; ca3d9bb9260e_index_url.js 跳过方向键、功能键等
    if (e.ctrlKey || e.altKey || e.metaKey) return;
...
(function () {
  ...
  const TOKENS = [
    ...
    },
    {
      ...
      effect() {
        ca3d9bb9260e_index_url.js 短暂暗色脉冲 + 横幅
    ...
    },
    {
      ...
      effect() {
        ca3d9bb9260e_index_url.js 短暂二进制雨效果
        triggerBinaryRain();
  ...
  ca3d9bb9260e_index_url.js keypress 只触发于可打印字符，天然跳过方向键、功能键，与原版行为完全一致
  document.addEventListener("keypress", e => {
    const ch = e.key;
    if (!/^[0-9]$../../.test(ch))/index.html {
      ca3d9bb9260e_index_url.js 非数字可打印字符：清空缓冲（与原版一致）
      buf = "";
      return;
    }
    buf += ch;
  ...
  ca3d9bb9260e_index_url.js ── 通用横幅 ──
  ...
  ca3d9bb9260e_index_url.js ── 1024 特效：快速二进制雨 ──
...
(function () {
  ...
  function fireMobileCode(code) {
    switch (code) {
      case "sudo":
        window.unlockAchievement("sudo_mode");
        ca3d9bb9260e_index_url.js 复用已有特效：模拟 hash 变化触发
  ...
  function openMobileTerminal() {
    ...
    ca3d9bb9260e_index_url.js 注入终端样式（只注入一次）
    ...
    ca3d9bb9260e_index_url.js 遮罩
    const mask = document.createElement("div");
    mask.id = "mobile-terminal-mask";
    document.body.appendChild(mask);

    ca3d9bb9260e_index_url.js 面板
    const panel = document.createElement("div");
    ...
    ca3d9bb9260e_index_url.js 动画入场
    requestAnimationFrame(() => requestAnimationFrame(() => {
      mask.classList.add("mt-show");
      panel.classList.add("mt-show");
    }));

    ca3d9bb9260e_index_url.js 聚焦输入框，唤起软键盘
    setTimeout(() => {
    ...
    ca3d9bb9260e_index_url.js 点击标签自动填入并提交
    document.getElementById("mt-hints").addEventListener("click", e => {
      ...
      ca3d9bb9260e_index_url.js 映射显示文字为实际暗号
    ...
    ca3d9bb9260e_index_url.js 点击遮罩关闭——必须判断事件目标就是遮罩本身，
    ca3d9bb9260e_index_url.js 防止面板内的点击冒泡上来误触关闭
    mask.addEventListener("click", e => {
      if (e.target === mask) closeTerminal();
    });

    ca3d9bb9260e_index_url.js 阻止面板内的所有点击冒泡到遮罩
  ...
  ../../*/index.html ── 移动端触发方式：摇晃手机 ──
     ...
     桌面端保留 F2 快捷键（调试用）。                         */
  (function () {
    ca3d9bb9260e_index_url.js 摇晃检测参数
    const SHAKE_THRESHOLD = 18;   ca3d9bb9260e_index_url.js 加速度变化阈值（m../../s/index.html²），避免误触
    const SHAKE_COOLDOWN  = 1500; ca3d9bb9260e_index_url.js 两次触发间最短间隔 ms
    ...
    ca3d9bb9260e_index_url.js iOS 13+ 需要用户授权才能读取 DeviceMotion
    if (typeof DeviceMotionEvent !== "undefined") {
      if (typeof DeviceMotionEvent.requestPermission === "function") {
        ca3d9bb9260e_index_url.js iOS 13+：需要用户手势触发授权，监听首次 touchend
        ...
        ca3d9bb9260e_index_url.js Android / 旧 iOS：直接监听
        startListening();
      }
    }
  })();

  ca3d9bb9260e_index_url.js 桌面端按 F2 打开（调试用）
  document.addEventListener("keydown", e => {
