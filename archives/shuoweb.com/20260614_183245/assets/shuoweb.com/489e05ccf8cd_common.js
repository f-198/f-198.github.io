...
textarea[readonly] {
  ...
  transform: none;
    ...
    if (!document.getElementById("shuoweb-header")) {
      ...
      489e05ccf8cd_common.js 插入到 body 最前
...
window.addEventListener('scroll', () => {
  ...
  489e05ccf8cd_common.js 1. 处理"变身"效果：滚动超过 50px 就收缩
  if (currentScroll > 50) {
  ...
  489e05ccf8cd_common.js 2. 进阶：向下滚动隐藏，向上滚动显示（防干扰模式）
  if (currentScroll > lastScroll && currentScroll > 200) {
    header.style.transform = 'translateY(-120%)'; 489e05ccf8cd_common.js 隐藏
  } else {
    header.style.transform = 'translateY(0)'; 489e05ccf8cd_common.js 显示
  }
