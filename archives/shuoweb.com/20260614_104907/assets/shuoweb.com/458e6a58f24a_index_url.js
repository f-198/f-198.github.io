...
(function () {
  ...
  style.textContent = `
    @font-face {
      font-family: 'ShuoWeb';
      src: url('e9faa8123b7d_font.ttf') format('truetype');
      font-weight: normal;
      font-style: normal;
      font-display: swap;
    }
  ...
  SITE_DATA.forEach((section, sIndex) => {
    ...
    section.items.forEach(item => {
      ...
      card.innerHTML = `
        ...
        <../../div/index.html>
        <div class="card-title">${item.title}<../../div/index.html>
      `;
...
(function () {
  ...
  ../../*/index.html ---------- SVG 图标库（替代 emoji）---------- */
  const ACH_SVG = {
    star:     `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/><../../svg/index.html>`,
    terminal: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/><../../svg/index.html>`,
    matrix:   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/><../../svg/index.html>`,
    glitch:   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3"/><../../svg/index.html>`,
    skull:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 2C8.13 2 5 5.13 5 9c0 2.38 1.19 4.47 3 5.74V17a2 2 0 002 2h4a2 2 0 002-2v-2.26C17.81 13.47 19 11.38 19 9c0-3.87-3.13-7-7-7z"/><line x1="9" y1="17" x2="9" y2="20"/><line x1="15" y1="17" x2="15" y2="20"/><line x1="9" y1="12" x2="9" y2="12.01"/><line x1="15" y1="12" x2="15" y2="12.01"/><../../svg/index.html>`,
    flame:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 2c0 0-5 5-5 10a5 5 0 0010 0c0-3-2-5-2-5s-1 2-3 2c0-3 0-7 0-7z"/><../../svg/index.html>`,
    keyboard: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="2" y="6" width="20" height="12" rx="2"/><line x1="6" y1="10" x2="6" y2="10"/><line x1="10" y1="10" x2="10" y2="10"/><line x1="14" y1="10" x2="14" y2="10"/><line x1="18" y1="10" x2="18" y2="10"/><line x1="6" y1="14" x2="18" y2="14"/><../../svg/index.html>`,
    heart:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/><../../svg/index.html>`,
    click:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18"/><../../svg/index.html>`,
    moon:     `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/><../../svg/index.html>`,
    search:   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><../../svg/index.html>`,
    folder:   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/><../../svg/index.html>`,
    crown:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M2 20h20M4 20l2-12 6 6 4-9 4 9 2-3 2 9"/><../../svg/index.html>`,
    gamepad:  `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="2" y="6" width="20" height="14" rx="2"/><path d="M6 14h4m-2-2v4"/><circle cx="15" cy="13" r="1" fill="currentColor"/><circle cx="18" cy="11" r="1" fill="currentColor"/><../../svg/index.html>`,
    lock:     `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0110 0v4"/><../../svg/index.html>`,
    zap:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/><../../svg/index.html>`,
    eye:      `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/><../../svg/index.html>`,
    copy:     `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/><../../svg/index.html>`,
    mouse:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="6" y="2" width="12" height="20" rx="6"/><line x1="12" y1="2" x2="12" y2="8"/><../../svg/index.html>`,
    anchor:   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="5" r="3"/><line x1="12" y1="8" x2="12" y2="22"/><path d="M5 12H2a10 10 0 0020 0h-3"/><../../svg/index.html>`,
    trophy:   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M6 9H4.5a2.5 2.5 0 010-5H6"/><path d="M18 9h1.5a2.5 2.5 0 000-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0012 0V2z"/><../../svg/index.html>`,
    question: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12" y2="17.01"/><../../svg/index.html>`,
    sunset:   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M17 18a5 5 0 00-10 0"/><line x1="12" y1="2" x2="12" y2="9"/><line x1="4.22" y1="10.22" x2="5.64" y2="11.64"/><line x1="1" y1="18" x2="3" y2="18"/><line x1="21" y1="18" x2="23" y2="18"/><line x1="18.36" y1="11.64" x2="19.78" y2="10.22"/><line x1="23" y1="22" x2="1" y2="22"/><polyline points="16 5 12 9 8 5"/><../../svg/index.html>`,
    scroll:   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/><../../svg/index.html>`,
    clock:    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/><../../svg/index.html>`,
  };

  ../../*/index.html ---------- 成就定义 ---------- */
  const ACHIEVEMENTS = [
    458e6a58f24a_index_url.js ── 公开成就 ──
    ...
    458e6a58f24a_index_url.js ── 隐藏成就 ──
    ...
    458e6a58f24a_index_url.js ── 新增成就 ──
    ...
    458e6a58f24a_index_url.js ── 终极成就 ──
  ...
  window.unlockAchievement = function (id) {
    ...
    if (unlocked.includes(id)) return;          458e6a58f24a_index_url.js 已解锁 → 直接退出
    const ach = ACHIEVEMENTS.find(a => a.id === id);
    if (!ach) return;
    unlocked.push(id);
    saveUnlocked(unlocked);
    showAchievementToast(ach);
    458e6a58f24a_index_url.js 检查全图鉴（排除 all_unlocked 自身）
  ...
  function showAchievementToast(ach) {
    ...
    const offset = existing.length * 90;          458e6a58f24a_index_url.js 多条堆叠偏移
    ...
    toast.innerHTML = `
      ...
      <div class="ach-toast-body">
        <div class="ach-toast-label">
          ${ACH_SVG.trophy}
          <span>成就解锁<../../span/index.html>
        <../../div/index.html>
        <div class="ach-toast-name">${ach.name}<../../div/index.html>
        <div class="ach-toast-desc">${ach.desc}<../../div/index.html>
      <../../div/index.html>
      <div class="ach-toast-progress"><../../div/index.html>
    `;
      ...
      return `
        <div class="ach-item ${done ? "ach-item--done" : "ach-item--locked"}">
          ...
          <div class="ach-item-text">
            <div class="ach-item-name">${hidden ? "???" : a.name}<../../div/index.html>
            <div class="ach-item-desc">${hidden ? "这是一个隐藏成就" : a.desc}<../../div/index.html>
          <../../div/index.html>
          ${done ? '<div class="ach-item-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/><../../svg/index.html><../../div/index.html>' : ""}
        <../../div/index.html>
      `;
    }).join("");
    ...
    panel.innerHTML = `
      <div class="ach-panel-header">
        <div class="ach-panel-title">
          <div class="ach-panel-title-icon">${ACH_SVG.trophy}<../../div/index.html>
          <span>成就<../../span/index.html>
          <span class="ach-panel-count">${count} / ${total}<../../span/index.html>
        <../../div/index.html>
        <button class="ach-panel-close" id="ach-panel-close-btn" aria-label="关闭">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/><../../svg/index.html>
        <../../button/index.html>
      <../../div/index.html>
      <div class="ach-progress-wrap">
        <div class="ach-progress-bar">
          <div class="ach-progress-fill" style="width:${pct}%"><../../div/index.html>
        <../../div/index.html>
        <span class="ach-progress-label">${pct}%<../../span/index.html>
      <../../div/index.html>
      <div class="ach-list">${items}<../../div/index.html>
      <div class="ach-panel-hint">
        桌面按 <kbd>?<../../kbd/index.html> &nbsp;·&nbsp; 移动端长按分区标题
      <../../div/index.html>
    `;
    document.body.appendChild(panel);

    458e6a58f24a_index_url.js 关闭按钮
    document.getElementById("ach-panel-close-btn").addEventListener("click", () => {
      panel.classList.remove("ach-panel--show");
      setTimeout(() => panel.remove(), 280);
    });

    458e6a58f24a_index_url.js 点击面板外关闭
    setTimeout(() => {
  ...
  ../../*/index.html ---------- 触发器：长按 section-title（移动端）---------- */
  (function () {
  ...
  (function () {
    ...
    window.addEventListener("scroll", () => {
      ...
      if (dt < 200 && dy / dt > 3) {        458e6a58f24a_index_url.js 速度阈值 px../../ms/index.html
        triggered = true;
  ...
  function injectStyles() {
    ...
    s.textContent = `
      ...
      #ach-panel {
        ...
        transition: none;
        ../../*/index.html 渐变描边边框 via outline + pseudo */
      }
      #ach-panel::before {
        content: '';
      ...
      #ach-panel::after {
        ...
        position: absolute; inset: 0;
        border-radius: inherit;
        background-image: url("data:image../../svg+xml,<svg/index.html viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.75' numOctaves='4' stitchTiles='stitch'../../></filter><rect/index.html width='100%25' height='100%25' filter='url(../../js/#n/index.html)' opacity='0.04'../../></svg>/index.html");
...
})(); 458e6a58f24a_index_url.js ← 成就系统结束


../../*/index.html ========================= 彩蛋 1: #sudo ========================= */
../../*/index.html
  触发方式：
...
(function () {
  ...
  function fireSudo() {
    if (triggered) return;
    triggered = true;
    458e6a58f24a_index_url.js 清除 hash，避免下次刷新重复触发
    if (window.location.hash === "#sudo") {
      try { history.replaceState(null, "", window.location.pathname + window.location.search); } catch(e){}
    }
    window.unlockAchievement("sudo_mode");
    triggerSudoEffect();
    458e6a58f24a_index_url.js 30 秒后允许再次触发（防重复已由 unlockAchievement 内部保证，此处只控制特效）
    setTimeout(() => { triggered = false; }, 30000);
  }

  458e6a58f24a_index_url.js ① URL hash 检测 —— 三重保险：load / hashchange / DOMContentLoaded
  function checkHash() {
  ...
  458e6a58f24a_index_url.js ② 键盘输入 "sudo"（纯字母，连续，无需 Enter）
  let sudoBuf = "";
  const SUDO_TARGET = "sudo";
  document.addEventListener("keydown", e => {
    if (e.ctrlKey || e.altKey || e.metaKey) return;
    if (e.key.length !== 1) return;            458e6a58f24a_index_url.js 跳过功能键、方向键
  ...
  458e6a58f24a_index_url.js ③ 视觉特效：终端风格全屏覆盖
  function triggerSudoEffect() {
    ...
    458e6a58f24a_index_url.js 打字机逐行输出
    const lines = [
    ...
    `;
    titleBar.innerHTML = `
      <div style="width:12px;height:12px;border-radius:50%;background:#ff5f56"><../../div/index.html>
      <div style="width:12px;height:12px;border-radius:50%;background:#ffbd2e"><../../div/index.html>
      <div style="width:12px;height:12px;border-radius:50%;background:#27c93f"><../../div/index.html>
      <span style="flex:1;text-align:center;font-size:12px;color:rgba(0,255,136,0.4);letter-spacing:0.1em">shuoweb — bash<../../span/index.html>
    `;
    ...
    458e6a58f24a_index_url.js 逐行打字机效果
    ...
    458e6a58f24a_index_url.js 点击关闭
    overlay.addEventListener("click", () => {
      overlay.style.opacity = "0";
      setTimeout(() => overlay.remove(), 350);
    });

    458e6a58f24a_index_url.js 4.5 秒后自动关闭
    setTimeout(() => {
...
../../*/index.html ========================= 彩蛋 2: 数字雨 (Matrix) ========================= */
../../*/index.html 触发方式：键盘输入 ↑↓↑↓（方向键）—— 必须用 keydown，keypress 不捕获方向键 */
(function () {
...
../../*/index.html ========================= 彩蛋 3: 故障美学 (Glitch) ========================= */
../../*/index.html 触发方式：键盘输入 glitch */
(function () {
  let buf = "";
  const TARGET = "glitch";
  document.addEventListener("keydown", e => {
    if (e.key.length !== 1) return; 458e6a58f24a_index_url.js 跳过方向键、功能键等
    if (e.ctrlKey || e.altKey || e.metaKey) return;
...
(function () {
  ...
  const TOKENS = [
    {
      ...
      effect() {
        showTokenBanner("114514", "#ff6b35",
          "臭名昭著",
          "这个数字承载了互联网的集体记忆",
          `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M12 2C8.13 2 5 5.13 5 9c0 2.38 1.19 4.47 3 5.74V17a2 2 0 002 2h4a2 2 0 002-2v-2.26C17.81 13.47 19 11.38 19 9c0-3.87-3.13-7-7-7z"/><../../svg/index.html>`
        );
      }
    },
    {
      ...
      effect() {
        458e6a58f24a_index_url.js 短暂暗色脉冲 + 横幅
        ...
        showTokenBanner("666666", "#c00060",
          "暗黑使徒",
          "六六六，传说中的黑暗之力已被你召唤",
          `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M12 2c0 0-5 5-5 10a5 5 0 0010 0c0-3-2-5-2-5s-1 2-3 2c0-3 0-7 0-7z"/><../../svg/index.html>`
        );
      }
    },
    {
      ...
      effect() {
        458e6a58f24a_index_url.js 短暂二进制雨效果
        triggerBinaryRain();
        showTokenBanner("1024", "#5ea8ff",
          "程序员节",
          "2^10 = 1024，以此致敬每一位码农",
          `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="2" y="6" width="20" height="12" rx="2"/><line x1="6" y1="10" x2="6" y2="10"/><line x1="10" y1="10" x2="10" y2="10"/><line x1="14" y1="10" x2="14" y2="10"/><line x1="18" y1="10" x2="18" y2="10"/><line x1="6" y1="14" x2="18" y2="14"/><../../svg/index.html>`
        );
      }
    },
  ];

  458e6a58f24a_index_url.js keypress 只触发于可打印字符，天然跳过方向键、功能键，与原版行为完全一致
  document.addEventListener("keypress", e => {
    const ch = e.key;
    if (!/^[0-9]$../../.test(ch))/index.html {
      458e6a58f24a_index_url.js 非数字可打印字符：清空缓冲（与原版一致）
      buf = "";
      return;
    }
    buf += ch;
  ...
  458e6a58f24a_index_url.js ── 通用横幅 ──
  function showTokenBanner(code, color, title, desc, iconSvg) {
    ...
    el.innerHTML = `
      ...
      <div style="font-size:22px;font-weight:900;color:${color};letter-spacing:0.06em;
        margin-bottom:6px;text-shadow:0 0 20px ${color}88;">${code}<../../div/index.html>
      <div style="font-size:15px;font-weight:700;color:#eeeef8;margin-bottom:6px;">${title}<../../div/index.html>
      <div style="font-size:12px;color:rgba(255,255,255,0.45);line-height:1.6;max-width:240px;">${desc}<../../div/index.html>
    `;
  ...
  458e6a58f24a_index_url.js ── 1024 特效：快速二进制雨 ──
  ...
  function triggerKonami() {
    ...
    banner.innerHTML = `
      <div style="width:52px;height:52px;margin:0 auto 12px;color:#fff;opacity:0.9">
        ...
        <../../svg/index.html>
      <../../div/index.html>
      <h2 style="margin:0 0 6px;font-size:20px;font-weight:800">Konami Code Activated!<../../h2/index.html>
      <p style="opacity:.75;font-size:13px;margin:0">↑↑↓↓←→←→BA · 传说中的秘籍<../../p/index.html>
    `;
  ...
  function triggerLoveLetter() {
    ...
    overlay.innerHTML = `
      <div style="width:60px;height:60px;color:#ff6b9d;animation:heartBeat 1s infinite alternate;margin-bottom:16px">
        ...
        <../../svg/index.html>
      <../../div/index.html>
      <h2 style="color:#ff6b9d;font-size:22px;margin:0 0 10px;font-weight:800">你找到了情书<../../h2/index.html>
      ...
      <../../p/index.html>
      <small style="color:rgba(255,255,255,0.2);font-size:11px;margin-top:28px">点击关闭<../../small/index.html>
      <style>@keyframes heartBeat{from{transform:scale(1)}to{transform:scale(1.18)}}<../../style/index.html>
    `;
    document.body.appendChild(overlay);
    requestAnimationFrame(() => {
...
(function () {
  ...
  function fireMobileCode(code) {
    switch (code) {
      case "sudo":
        window.unlockAchievement("sudo_mode");
        458e6a58f24a_index_url.js 复用已有特效：模拟 hash 变化触发
  ...
  function showMobileTokenBanner(code, color, title, desc) {
    ...
    el.innerHTML = `
      <div style="font-size:26px;font-weight:900;color:${color};letter-spacing:0.06em;
        margin-bottom:8px;text-shadow:0 0 20px ${color}88;">${code}<../../div/index.html>
      <div style="font-size:15px;font-weight:700;color:#eeeef8;margin-bottom:6px;">${title}<../../div/index.html>
      <div style="font-size:12px;color:rgba(255,255,255,0.45);line-height:1.6;">${desc}<../../div/index.html>
    `;
    document.body.appendChild(el);
    requestAnimationFrame(() => requestAnimationFrame(() => {
      el.style.opacity = "1";
  ...
  function openMobileTerminal() {
    ...
    458e6a58f24a_index_url.js 遮罩
    const mask = document.createElement("div");
    mask.id = "mobile-terminal-mask";
    document.body.appendChild(mask);

    458e6a58f24a_index_url.js 面板
    const panel = document.createElement("div");
    panel.id = "mobile-terminal";
    panel.innerHTML = `
      <div class="mt-handle"><../../div/index.html>
      <div class="mt-titlebar">
        <div class="mt-dot" style="background:#ff5f56"><../../div/index.html>
        <div class="mt-dot" style="background:#ffbd2e"><../../div/index.html>
        <div class="mt-dot" style="background:#27c93f"><../../div/index.html>
        <div class="mt-title">shuoweb — secret terminal<../../div/index.html>
        <button class="mt-close-btn" id="mt-close">✕<../../button/index.html>
      <../../div/index.html>
      <div class="mt-output" id="mt-output">
        <div class="mt-output-line" style="color:rgba(0,255,136,0.5);">上上下下左右左右BA...<../../div/index.html>
        <div class="mt-output-line" style="color:rgba(0,255,136,0.4);animation-delay:0.1s">输入暗号解锁隐藏彩蛋<../../div/index.html>
      <../../div/index.html>
      <div class="mt-hints" id="mt-hints">
        <span class="mt-hint-tag" data-code="sudo">sudo<../../span/index.html>
        <span class="mt-hint-tag" data-code="glitch">glitch<../../span/index.html>
        <span class="mt-hint-tag" data-code="shuo">shuo<../../span/index.html>
        <span class="mt-hint-tag" data-code="114514">114514<../../span/index.html>
        <span class="mt-hint-tag" data-code="666666">666666<../../span/index.html>
        <span class="mt-hint-tag" data-code="1024">1024<../../span/index.html>
        <span class="mt-hint-tag" data-code="matrix">上上下下<../../span/index.html>
        <span class="mt-hint-tag" data-code="konami">konami<../../span/index.html>
      <../../div/index.html>
      <div class="mt-input-row">
        <span class="mt-prompt">$&nbsp;<../../span/index.html>
        <div class="mt-input-wrap">
          <input class="mt-input" id="mt-input" type="text"
                 placeholder="输入暗号..." autocomplete="off"
                 autocorrect="off" autocapitalize="off" spellcheck="false" />
        <../../div/index.html>
        <button class="mt-send-btn" id="mt-send">执行<../../button/index.html>
      <../../div/index.html>
    `;
    document.body.appendChild(panel);

    458e6a58f24a_index_url.js 动画入场
    requestAnimationFrame(() => requestAnimationFrame(() => {
      mask.classList.add("mt-show");
      panel.classList.add("mt-show");
    }));

    458e6a58f24a_index_url.js 聚焦输入框，唤起软键盘
    setTimeout(() => {
    ...
    458e6a58f24a_index_url.js 点击标签自动填入并提交
    document.getElementById("mt-hints").addEventListener("click", e => {
      ...
      458e6a58f24a_index_url.js 映射显示文字为实际暗号
    ...
    458e6a58f24a_index_url.js 点击遮罩关闭——必须判断事件目标就是遮罩本身，
    458e6a58f24a_index_url.js 防止面板内的点击冒泡上来误触关闭
    mask.addEventListener("click", e => {
      if (e.target === mask) closeTerminal();
    });

    458e6a58f24a_index_url.js 阻止面板内的所有点击冒泡到遮罩
    panel.addEventListener("click", e => e.stopPropagation());
  }

  ../../*/index.html ── 移动端触发方式：摇晃手机 ──
     完全不可见，不依赖任何页面元素，与成就面板长按彻底隔离。
     同时新增「摇晃手机」成就。
     桌面端保留 F2 快捷键（调试用）。                         */
  (function () {
    458e6a58f24a_index_url.js 摇晃检测参数
    const SHAKE_THRESHOLD = 18;   458e6a58f24a_index_url.js 加速度变化阈值（m../../s/index.html²），避免误触
    const SHAKE_COOLDOWN  = 1500; 458e6a58f24a_index_url.js 两次触发间最短间隔 ms
    ...
    458e6a58f24a_index_url.js iOS 13+ 需要用户授权才能读取 DeviceMotion
    if (typeof DeviceMotionEvent !== "undefined") {
      if (typeof DeviceMotionEvent.requestPermission === "function") {
        458e6a58f24a_index_url.js iOS 13+：需要用户手势触发授权，监听首次 touchend
        ...
        458e6a58f24a_index_url.js Android / 旧 iOS：直接监听
        startListening();
      }
    }
  })();

  458e6a58f24a_index_url.js 桌面端按 F2 打开（调试用）
  document.addEventListener("keydown", e => {
