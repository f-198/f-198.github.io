...
../../*/index.html =============================== 全局通用 DIV 样式 =============================== */
../../*/index.html 这里的策略是针对作为“直接子级”或“块级容器”的 div 进行增强 */
div {
    ../../*/index.html 继承主题定义的变量 */
    border-radius: var(--radius);
    transition: var(--transition);
    ../../*/index.html 默认不加背景，但如果是主要内容块，它会显得非常干净 */
}

../../*/index.html 模拟卡片效果：自动识别具有实际内容的 div (可选，让布局更高级) */
div:not(:empty) {
    box-shadow: 0 0 0 1px rgba(255, 255, 255, 0.1); ../../*/index.html 极其微弱的边框线 */
}

../../*/index.html =============================== 全局通用 INPUT 样式 =============================== */
input {
    ../../*/index.html 基础尺寸与间距 */
    width: 100%; ../../*/index.html 可根据需要改 auto */
    max-width: 400px;
    padding: 12px 16px;
    margin: 8px 0;
    
    ../../*/index.html 核心视觉：磨砂玻璃感 */
    background: var(--card-bg);
    border: 1px solid rgba(255, 255, 255, 0.3);
    border-radius: var(--radius); ../../*/index.html 自动跟随全局圆角 */
    ...
    -webkit-appearance: none; ../../*/index.html 移除移动端原生阴影 */
}
...
../../*/index.html 重点：获取焦点时的状态 */
input:focus {
    background: #ffffff; ../../*/index.html 聚焦时变白，增加对比度 */
    border-color: var(--primary); ../../*/index.html 边框变主题色 */
    box-shadow: 0 0 0 4px var(--primary-light); ../../*/index.html 呼吸灯外发光 */
    transform: translateY(-1px); ../../*/index.html 轻微上浮感 */
}

../../*/index.html 针对粉色主题的自动适配 (如果需要特殊微调) */
...
../../*/index.html =============================== 全局通用 BUTTON 样式 =============================== */
../../*/index.html 彻底重写所有原生按钮，使其符合克莱因蓝/极客粉主题 */
button {
    ../../*/index.html 基础布局 */
    display: inline-flex;
    align-items: center;
...
../../*/index.html 点击反馈：物理压感回弹 */
button:active {
    transform: translateY(1px) scale(0.95);
    box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);
    transition: all 0.1s ease; ../../*/index.html 瞬间反馈 */
}

../../*/index.html 扫光动效：利用伪元素实现 */
button::before {
    content: "";
    position: absolute;
    top: 0;
...
../../*/index.html 无下划线链接（加 class="link-plain"） */
.link-plain {
  text-decoration: none !important;
}

../../*/index.html 按钮式链接（加 class="link-btn"） */
.link-btn {
  display: inline-flex;
  align-items: center;
  gap: 6px;
...
../../*/index.html 1. 基础类：平时持续跳动，同时备好过渡效果 */
.combo-duang {
  display: inline-block;
  will-change: transform;
  
  ../../*/index.html 挂载持续跳动的动画 (假设你已经定义了 continuous-duang 关键帧) */
  animation: continuous-duang 2.5s infinite ease-in-out;
  
  ../../*/index.html 提前写好过渡曲线，等动画停掉时，这个过渡就会生效 */
  transition: transform 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275),
              box-shadow 0.4s ease;
}

../../*/index.html 2. 悬浮状态：打断动画，执行放大 */
.combo-duang:hover {
  ../../*/index.html 关键：取消循环动画，防止它干扰悬停效果 */
  animation: none; 
  
  ../../*/index.html 执行常规的交互 Duang */
  transform: scale(1.05) translateY(-3px);
  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.12);
}

../../*/index.html 3. 点击状态：打断动画，执行下压 */
.combo-duang:active {
  animation: none;
...
../../*/index.html 之前写过的关键帧 (如果你没存的话，贴在这里) */
...
.nav-list {
  ...
  position: relative;
  padding: 8px;
  background: rgba(255, 255, 255, 0.1); ../../*/index.html 在磨砂之上加一层极淡的背景 */
  border-radius: 50px;
}
...
../../*/index.html 使用伪元素制作跟随滑块 */
../../*/index.html 注意：这个纯CSS方案是针对单个Item的，若需跨Item平滑移动需少量JS */
.nav-link::before {
  content: '';
  position: absolute;
  ...
  opacity: 0;
  transform: scale(0.8);
  transition: all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1); ../../*/index.html 带有弹性回弹 */
}
...
.nav-link {
  ...
  color: transparent; ../../*/index.html 隐藏原始文字颜色 */
...
../../*/index.html 滚动状态 (需要配合简单的 JS 添加 .scrolled 类) */
.header.scrolled {
  top: 20px;
  width: 90%; ../../*/index.html 宽度收缩 */
  left: 5%;
  border-radius: 20px;
  padding: 10px 0;
...
../../*/index.html 悬停时的"胶囊"背景 */
.nav-item::before {
  content: "";
  position: absolute;
  inset: 5px -10px; ../../*/index.html 控制胶囊的大小范围 */
...
.navbar {
  ../../*/index.html 你现有的属性... */
  position: relative;
  overflow: hidden; ../../*/index.html 裁剪流光 */
}

../../*/index.html 增加一根流动的细线 */
.navbar::after {
  content: "";
  position: absolute;
  bottom: 0;
...
../../*/index.html 视频外层包裹（用于居中、间距、磨砂背景） */
.video-box {
  position: relative;
  width: 100%;
  max-width: 800px;
...
../../*/index.html 让所有包含链接的容器也自动居中 */
body {
  text-align: center;
}

../../*/index.html 每日一言 - 刷新句子按钮 */
.refresh-btn {
  cursor: pointer;
  border: none;
  background: var(--primary);
...
textarea {
  ...
  padding: 14px 16px;
  margin: 10px 0;
  resize: vertical; ../../*/index.html 允许垂直拖动 */

  ../../*/index.html 磨砂玻璃质感（和 input 保持一致） */
  background: var(--card-bg);
  border: 1px solid rgba(255, 255, 255, 0.3);
  border-radius: var(--radius);
  box-shadow: var(--shadow);
...
textarea[readonly] {
  ...
  transform: none;
    ...
    if (!document.getElementById("shuoweb-header")) {
      ...
      header.innerHTML = `
        <div class="logo">SHUOWEB<../../div/index.html>
        <button class="theme-btn" id="themeText">切换主题<../../button/index.html>
      `;

      3078243d61e8_common.js 插入到 body 最前
  ...
  footer.innerHTML = `
    <div class="footer-links">
      <a href="https://github.com/free-4/free-4.github.io/issues" class="footer-link" target="_blank">评论区<../../a/index.html>
    <../../div/index.html>
    <p>&copy; 2026 SHUOWEB.COM<../../p/index.html><br>
    页面浏览量：<span id="vercount_value_page_pv">Loading<../../span/index.html>
  `;
...
window.addEventListener('scroll', () => {
  ...
  3078243d61e8_common.js 1. 处理"变身"效果：滚动超过 50px 就收缩
  if (currentScroll > 50) {
...
(function () {
    ...
    function injectStyle() {
        ...
        style.textContent = `
            ...
            ../../*/index.html ── 按钮：全部使用实色背景 + 白色文字，确保高对比度 ── */
            ...
            @media (max-width: 600px) {
                ...
                ../../*/index.html 回顶按钮适配底部安全区 */
                #shuo-totop-btn {
                    bottom: calc(76px + env(safe-area-inset-bottom, 0px));
                    right: 16px;
                    width: 44px; height: 44px;
                }
                ../../*/index.html Toast 留出安全区 */
                .shuo-toast {
    ...
    function createDOM() {
        ...
        CATEGORIES.forEach(cat => {
            ...
            listHTML += `<div class="shuo-cat-label" data-label="${cat.id}">${cat.label}<../../div/index.html>`;
            items.forEach(opt => {
                ...
                listHTML += `
                    <div class="shuo-setting-item" data-cat="${opt.category}" data-name="${opt.name}">
                        <div class="shuo-setting-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">${opt.icon}<../../svg/index.html>
                        <../../div/index.html>
                        <div class="shuo-setting-info">
                            <div class="shuo-setting-name">${opt.name}<../../div/index.html>
                            <div class="shuo-setting-desc" id="desc-${opt.id}">${opt.desc}<../../div/index.html>
                        <../../div/index.html>
                        ${control}
                    <../../div/index.html>`;
            });
        ...
        const svgShare  = `<svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round"
            ...
            00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"/><../../svg/index.html>`;
        const svgExport = `<svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round"
            d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/><../../svg/index.html>`;
        const svgImport = `<svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round"
            d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/><../../svg/index.html>`;
        const svgTrash  = `<svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round"
            d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6
            m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/><../../svg/index.html>`;
        ...
        mask.innerHTML = `
            <div class="shuo-settings-panel" id="shuoweb-settings-panel">
                ...
                <div class="shuo-settings-footer">
                    <button class="shuo-btn primary" id="btn-copy-url">${svgShare} 分享入口<../../button/index.html>
                    <button class="shuo-btn success"  id="btn-export">${svgExport} 导出配置<../../button/index.html>
                    <button class="shuo-btn warning"  id="btn-import">${svgImport} 导入配置<../../button/index.html>
                    <button class="shuo-btn danger"   id="btn-clear-data">${svgTrash} 重置引擎<../../button/index.html>
                <../../div/index.html>
            <../../div/index.html>
        `;
        ...
        ../../*/index.html ── 回顶按钮（内联 SVG 属性，确保任意宿主页面均可渲染）── */
    ...
    function bindEvents() {
        ...
        document.getElementById('btn-export').addEventListener('click', () => {
            ...
            const blob = new Blob([JSON.stringify(cfg, null, 2)], { type: 'application../../json'/index.html });
            const url = URL.createObjecturl(../../blob/index.html);
            const a = Object.assign(document.createElement('a'), {
                href: url, download: `engineers-pro-${Date.now()}.json`
            });
            a.click(); URL.revokeObjecturl(../../url/index.html);
            showToast('✓ 配置已导出');
        });
    ...
    ../../*/index.html ── 搜索过滤（已移除分类 Tab，仅保留文字搜索）── */
    function filterItems(query) {
        ...
        ../../*/index.html 若某分类下所有项都被搜索隐藏，也隐藏分类标签 */
