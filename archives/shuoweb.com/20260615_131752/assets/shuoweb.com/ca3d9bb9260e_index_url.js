...
(function () {
  ...
  style.textContent = `
    @font-face {
      font-family: 'ShuoWeb';
      src: url('assets/shuoweb.com/e9faa8123b7d_font.ttf') format('truetype');
      font-weight: normal;
      font-style: normal;
      font-display: swap;
    }
  ...
  function injectStyles() {
    ...
    s.textContent = `
      ...
      #ach-panel::after {
        ...
        position: absolute; inset: 0;
        border-radius: inherit;
        background-image: url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.75' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(js/#n/index.html)' opacity='0.04'/%3E%3C/svg%3E");
