...
function _showDynClicks(clicktype, owner, clickid)
{
    try
    {
        ...
        var url = '../../system/resource/code/news/click/dynclicks_38b2638b.jsp
...
function _showDynClickBatch(spanids,wbnewsids,clicktype, owner)
{
    ...
    try
    {
        var url = '../../system/resource/code/news/click/dynclicksbatch_be3cefd0.jsp
...
function _addDynClicks(clicktype, owner, clickid)
{
    try
    {
        var url = '../../system/resource/code/news/click/addclicktimes_5b44a10a.jsp + clickid + '&owner=' + owner + '&type=' + clicktype;
        var xmlhttp = _dynClicks_ajax();
        xmlhttp.open("GET",url, true);
        xmlhttp.send();
    }
