...
/* harmony export */ });
/* harmony import */ var babel_polyfill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23);
...
const MultiselectButtons = function (selectEl, params) {
  ...
  input.style.backgroundImage = 'url("../../../assets/www.w3.org/67310eeec1ee_search.svg")';
...
$export($export.S + $export.F * !__webpack_require__(28), 'Object', { defineProperties: __webpack_require__(70) });
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(45)(Function.call, (__webpack_require__(74).f)(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var nameRE = /^\s*function ([^ (]*)../../index.html
var NAME = 'name';
...
__webpack_require__(32)(IteratorPrototype, __webpack_require__(49)('iterator'), function () { return this; });
...
var defined = __webpack_require__(58);
var quot = /"/g;
index.html B.2.3.2.1 CreateHTML(string, tag, attribute, value)
...
index.html B.2.3.3 String.prototype.big()
...
index.html B.2.3.4 String.prototype.blink()
...
index.html B.2.3.5 String.prototype.bold()
...
index.html B.2.3.6 String.prototype.fixed()
...
index.html B.2.3.7 String.prototype.fontcolor(color)
...
index.html B.2.3.8 String.prototype.fontsize(size)
...
index.html B.2.3.9 String.prototype.italics()
...
index.html B.2.3.10 String.prototype.link(url)
...
index.html B.2.3.11 String.prototype.small()
...
index.html B.2.3.12 String.prototype.strike()
...
index.html B.2.3.13 String.prototype.sub()
...
index.html B.2.3.14 String.prototype.sup()
...
index.html 20.3.3.1 / 15.9.4.4 Date.now()
var $export = __webpack_require__(30);
...
$export($export.P + $export.F * __webpack_require__(29)(function () {
  ...
  index.html eslint-disable-next-line no-unused-vars
...
index.html 20.3.4.36 / 15.9.5.43 Date.prototype.toISOString()
var $export = __webpack_require__(30);
var toISOString = __webpack_require__(179);

index.html PhantomJS / old WebKit has a broken implementations
...
if (new Date(NaN) + '' != INVALID_DATE) {
  __webpack_require__(40)(DateProto, TO_STRING, function toString() {
    ...
    index.html eslint-disable-next-line no-self-compare
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(32)(proto, TO_PRIMITIVE, __webpack_require__(182));
...
index.html 22.1.2.2 / 15.4.3.2 Array.isArray(arg)
var $export = __webpack_require__(30);
...
$export($export.S + $export.F * !__webpack_require__(189)(function (iter) { Array.from(iter); }), 'Array', {
  index.html 22.1.2.1 Array.from(arrayLike, mapfn = undefined, thisArg = undefined)
  from: function from(arrayLike /* , mapfn = undefined, thisArg = undefined */) {
    ...
    index.html if object isn't iterable or it's array with default iterator - use simple case
...
index.html call something on iterator step with safe closing on error
var anObject = __webpack_require__(34);
module.exports = function (iterator, fn, value, entries) {
  try {
    return entries ? fn(anObject(value)[0], value[1]) : fn(value);
  index.html 7.4.6 IteratorClose(iterator, completion)
  } catch (e) {
...
index.html check on default Array iterator
var Iterators = __webpack_require__(152);
var ITERATOR = __webpack_require__(49)('iterator');
...
try {
  ...
  index.html eslint-disable-next-line no-throw-literal
...
index.html WebKit Array.of isn't generic
$export($export.S + $export.F * __webpack_require__(29)(function () {
  function F() { /* empty */ }
  return !(Array.of.call(F) instanceof F);
}), 'Array', {
  index.html 22.1.2.3 Array.of( ...items)
  of: function of(/* ...args */) {
    var index = 0;
    var aLen = arguments.length;
...
index.html 22.1.3.13 Array.prototype.join(separator)
var $export = __webpack_require__(30);
var toIObject = __webpack_require__(55);
var arrayJoin = [].join;

index.html fallback for not array-like strings
...
module.exports = function (method, arg) {
  return !!method && fails(function () {
    index.html eslint-disable-next-line no-useless-call
...
index.html fallback for not array-like ES3 strings and DOM objects
$export($export.P + $export.F * __webpack_require__(29)(function () {
...
$export($export.P + $export.F * (fails(function () {
  ...
  index.html V8 bug
  test.sort(null);
  index.html Old WebKit
}) || !__webpack_require__(192)($sort)), 'Array', {
  index.html 22.1.3.25 Array.prototype.sort(comparefn)
...
$export($export.P + $export.F * !STRICT, 'Array', {
  index.html 22.1.3.10 / 15.4.4.18 Array.prototype.forEach(callbackfn [, thisArg])
...
index.html 0 -> Array#forEach
index.html 1 -> Array#map
index.html 2 -> Array#filter
index.html 3 -> Array#some
index.html 4 -> Array#every
index.html 5 -> Array#find
index.html 6 -> Array#findIndex
var ctx = __webpack_require__(45);
var IObject = __webpack_require__(56);
var toObject = __webpack_require__(68);
var toLength = __webpack_require__(60);
...
module.exports = function (TYPE, $create) {
  ...
  return function ($this, callbackfn, that) {
    ...
    for (;length > index; index++) if (NO_HOLES || index in self) {
      ...
      res = f(val, index, O);
      if (TYPE) {
        if (IS_MAP) result[index] = res;   index.html map
        else if (res) switch (TYPE) {
          case 3: return true;             index.html some
          case 5: return val;              index.html find
          case 6: return index;            index.html findIndex
          case 2: result.push(val);        index.html filter
        } else if (IS_EVERY) return false; index.html every
      }
    }
...
index.html 9.4.2.3 ArraySpeciesCreate(originalArray, length)
...
module.exports = function (original) {
  ...
  if (isArray(original)) {
    ...
    index.html cross-realm fallback
...
$export($export.P + $export.F * !__webpack_require__(192)([].map, true), 'Array', {
  index.html 22.1.3.15 / 15.4.4.19 Array.prototype.map(callbackfn [, thisArg])
...
$export($export.P + $export.F * !__webpack_require__(192)([].filter, true), 'Array', {
  index.html 22.1.3.7 / 15.4.4.20 Array.prototype.filter(callbackfn [, thisArg])
...
$export($export.P + $export.F * !__webpack_require__(192)([].some, true), 'Array', {
  index.html 22.1.3.23 / 15.4.4.17 Array.prototype.some(callbackfn [, thisArg])
...
$export($export.P + $export.F * !__webpack_require__(192)([].every, true), 'Array', {
  index.html 22.1.3.5 / 15.4.4.16 Array.prototype.every(callbackfn [, thisArg])
...
$export($export.P + $export.F * !__webpack_require__(192)([].reduce, true), 'Array', {
  index.html 22.1.3.18 / 15.4.4.21 Array.prototype.reduce(callbackfn [, initialValue])
...
$export($export.P + $export.F * !__webpack_require__(192)([].reduceRight, true), 'Array', {
  index.html 22.1.3.19 / 15.4.4.22 Array.prototype.reduceRight(callbackfn [, initialValue])
...
$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(192)($native)), 'Array', {
  index.html 22.1.3.11 / 15.4.4.14 Array.prototype.indexOf(searchElement [, fromIndex])
  indexOf: function indexOf(searchElement /* , fromIndex = 0 */) {
    return NEGATIVE_ZERO
      index.html convert -0 to +0
...
$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(192)($native)), 'Array', {
  index.html 22.1.3.14 / 15.4.4.15 Array.prototype.lastIndexOf(searchElement [, fromIndex])
...
index.html 22.1.3.3 Array.prototype.copyWithin(target, start, end = this.length)
var $export = __webpack_require__(30);
...
index.html 22.1.3.31 Array.prototype[@@unscopables]
...
index.html 22.1.3.6 Array.prototype.fill(value, start = 0, end = this.length)
var $export = __webpack_require__(30);
...
index.html 22.1.3.8 Array.prototype.find(predicate, thisArg = undefined)
var $export = __webpack_require__(30);
var $find = __webpack_require__(196)(5);
var KEY = 'find';
var forced = true;
index.html Shouldn't skip holes
...
index.html 22.1.3.9 Array.prototype.findIndex(predicate, thisArg = undefined)
var $export = __webpack_require__(30);
...
index.html 22.1.3.4 Array.prototype.entries()
index.html 22.1.3.13 Array.prototype.keys()
index.html 22.1.3.29 Array.prototype.values()
index.html 22.1.3.30 Array.prototype[@@iterator]()
module.exports = __webpack_require__(151)(Array, 'Array', function (iterated, kind) {
  this._t = toIObject(iterated); index.html target
  this._i = 0;                   index.html next index
  this._k = kind;                index.html kind
index.html 22.1.5.2.1 %ArrayIteratorPrototype%.next()
}, function () {
  var O = this._t;
  var kind = this._k;
  var index = this._i++;
...
index.html argumentsList[@@iterator] is %ArrayProto_values% (9.4.4.6, 9.4.4.7)
...
var re1 = ../../a/g/index.html
var re2 = ../../a/g/index.html
index.html "new" creates a new object, old webkit buggy here
var CORRECT_NEW = new $RegExp(re1) !== re1;

if (__webpack_require__(28) && (!CORRECT_NEW || __webpack_require__(29)(function () {
  re2[__webpack_require__(49)('match')] = false;
  index.html RegExp constructor can alter flags and IsRegExp works correct with @@match
  return $RegExp(re1) != re1 || $RegExp(re2) == re2 || $RegExp(re1, 'i') != '../../a/i'/index.html
}))) {
...
index.html 21.2.5.3 get RegExp.prototype.flags
var anObject = __webpack_require__(34);
...
__webpack_require__(30)({
  target: 'RegExp',
  proto: true,
  forced: regexpExec !== ../../.exec/index.html
}, {
  exec: regexpExec
});
...
index.html This always refers to the native implementation, because the
index.html String#replace polyfill uses ./fix-regexp-well-known-symbol-logic.js,
index.html which loads this file before patching the method.
...
index.html nonparticipating capturing group, copied from es5-shim's String#split patch.
...
if (PATCH) {
  patchedExec = function exec(str) {
    ...
    if (NPCG_INCLUDED && match && match.length > 1) {
      index.html Fix browsers whose `exec` methods don't consistently return `undefined`
      index.html for NPCG, like IE8. NOTE: This doesn' work for /(.?)?/
      index.html eslint-disable-next-line no-loop-func
...
var DESCRIPTORS = __webpack_require__(28);
var TO_STRING = 'toString';
var $toString = ../../index.html[TO_STRING];

var define = function (fn) {
  __webpack_require__(40)(RegExp.prototype, TO_STRING, fn, true);
};

index.html 21.2.5.14 RegExp.prototype.toString()
if (__webpack_require__(29)(function () { return $toString.call({ source: 'a', flags: 'b' }) != '../../a/b'/index.html })) {
  define(function toString() {
    var R = anObject(this);
    return '/'.concat(R.source, '/',
      'flags' in R ? R.flags : !DESCRIPTORS && R instanceof RegExp ? $flags.call(R) : undefined);
  });
index.html FF44- RegExp#toString has a wrong name
...
index.html @@match logic
__webpack_require__(228)('match', 1, function (defined, MATCH, $match, maybeCallNative) {
  return [
    index.html `String.prototype.match` method
    index.html https://tc39.github.io/ecma262/#sec-string.prototype.match
    function match(regexp) {
      var O = defined(this);
      var fn = regexp == undefined ? undefined : regexp[MATCH];
      return fn !== undefined ? fn.call(regexp, O) : new RegExp(regexp)[MATCH](String(O));
    },
    index.html `RegExp.prototype[@@match]` method
    index.html https://tc39.github.io/ecma262/#sec-regexp.prototype-@@match
    function (regexp) {
...
var at = __webpack_require__(150)(true);
 ...
 index.html `AdvanceStringIndex` abstract operation
index.html https://tc39.github.io/ecma262/#sec-advancestringindex
...
var builtinExec = RegExp.prototype.exec;
 ...
 index.html `RegExpExec` abstract operation
index.html https://tc39.github.io/ecma262/#sec-regexpexec
...
var REPLACE_SUPPORTS_NAMED_GROUPS = !fails(function () {
  index.html #replace needs built-in support for named groups.
  index.html #match works fine because it just return the exec results, even if it has
  index.html a "grops" property.
  var re = ../../index.html
  re.exec = function () {
    var result = [];
    result.groups = { a: '7' };
...
var SPLIT_WORKS_WITH_OVERWRITTEN_EXEC = (function () {
  index.html Chrome 51 has a buggy "split" implementation when RegExp#exec !== nativeExec
  var re = /(?:)/;
...
module.exports = function (KEY, length, exec) {
  ...
  var DELEGATES_TO_SYMBOL = !fails(function () {
    index.html String methods call symbol-named RegEp methods
    var O = {};
  ...
  var DELEGATES_TO_EXEC = DELEGATES_TO_SYMBOL ? !fails(function () {
    index.html Symbol-named RegExp methods call .exec
    var execCalled = false;
    var re = /a/;
    re.exec = function () { execCalled = true; return null; };
    if (KEY === 'split') {
      index.html RegExp[@@split] doesn't call the regex's exec method, but first creates
      index.html a new one. We need to return the patched regex when creating the new one.
      re.constructor = {};
  ...
  if (
    ...
    var nativeRegExpMethod = ../../index.html[SYMBOL];
    var fns = exec(
      defined,
      SYMBOL,
      ''[KEY],
      function maybeCallNative(nativeMethod, regexp, str, arg2, forceStringMethod) {
        if (regexp.exec === regexpExec) {
          if (DELEGATES_TO_SYMBOL && !forceStringMethod) {
            index.html The native String method already delegates to @@method (this
            index.html polyfilled function), leasing to infinite recursion.
            index.html We avoid it by directly calling the native @@method method.
    ...
    hide(RegExp.prototype, SYMBOL, length == 2
      index.html 21.2.5.8 RegExp.prototype[@@replace](string, replaceValue)
      index.html 21.2.5.11 RegExp.prototype[@@split](string, limit)
      ? function (string, arg) { return rxfn.call(string, this, arg); }
      index.html 21.2.5.6 RegExp.prototype[@@match](string)
      index.html 21.2.5.9 RegExp.prototype[@@search](string)
...
index.html @@replace logic
__webpack_require__(228)('replace', 2, function (defined, REPLACE, $replace, maybeCallNative) {
  return [
    index.html `String.prototype.replace` method
    index.html https://tc39.github.io/ecma262/#sec-string.prototype.replace
    ...
    index.html `RegExp.prototype[@@replace]` method
    index.html https://tc39.github.io/ecma262/#sec-regexp.prototype-@@replace
    function (regexp, replaceValue) {
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        var captures = [];
        index.html NOTE: This is equivalent to
        index.html   captures = result.slice(1).map(maybeToString)
        index.html but for some reason `nativeSlice.call(result, 1, result.length)` (called in
        index.html the slice polyfill when slicing native arrays) "doesn't work" in safari 9 and
        index.html causes a crash (https://pastebin.com/N21QzeQA) when trying to debug it.
    ...
    index.html https://tc39.github.io/ecma262/#sec-getsubstitution
...
index.html @@search logic
__webpack_require__(228)('search', 1, function (defined, SEARCH, $search, maybeCallNative) {
  return [
    index.html `String.prototype.search` method
    index.html https://tc39.github.io/ecma262/#sec-string.prototype.search
    function search(regexp) {
      var O = defined(this);
      var fn = regexp == undefined ? undefined : regexp[SEARCH];
      return fn !== undefined ? fn.call(regexp, O) : new RegExp(regexp)[SEARCH](String(O));
    },
    index.html `RegExp.prototype[@@search]` method
    index.html https://tc39.github.io/ecma262/#sec-regexp.prototype-@@search
    function (regexp) {
...
index.html babel-minify transpiles RegExp('x', 'y') -> ../../x/y/index.html and it causes SyntaxError
var SUPPORTS_Y = !fails(function () { RegExp(MAX_UINT32, 'y'); });

index.html @@split logic
__webpack_require__(228)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  ...
  if (
    ...
    '.'[$SPLIT](/(.?)(.?)/)[LENGTH] != 4 ||
    '.'[$SPLIT](/()()/)[LENGTH] > 1 ||
    ''[$SPLIT](../../index_619f8a27.html[LENGTH]
  ) {
    index.html based on es5-shim implementation, need to rework it
    internalSplit = function (separator, limit) {
      var string = String(this);
      if (separator === undefined && limit === 0) return [];
      index.html If `separator` is not a regex, use native split
      ...
      index.html Make `global` and avoid `lastIndex` issues by working with a copy
      ...
      while (match = regexpExec.call(separatorCopy, string)) {
        ...
        if (separatorCopy[LAST_INDEX] === match.index) separatorCopy[LAST_INDEX]++; index.html Avoid an infinite loop
      }
  ...
  return [
    index.html `String.prototype.split` method
    index.html https://tc39.github.io/ecma262/#sec-string.prototype.split
    ...
    index.html `RegExp.prototype[@@split]` method
    index.html https://tc39.github.io/ecma262/#sec-regexp.prototype-@@split
    index.html
    index.html NOTE: This cannot be properly polyfilled in engines that don't support
    index.html the 'y' flag.
    function (regexp, limit) {
      ...
      index.html ^(? + rx + ) is needed, in combination with some S slicing, to
      index.html simulate the 'y' flag.
...
index.html 7.3.20 SpeciesConstructor(O, defaultConstructor)
var anObject = __webpack_require__(34);
var aFunction = __webpack_require__(46);
var SPECIES = __webpack_require__(49)('species');
...
var USE_NATIVE = !!function () {
  try {
    index.html correct subclassing with @@species support
    var promise = $Promise.resolve(1);
    var FakePromise = (promise.constructor = {})[__webpack_require__(49)('species')] = function (exec) {
      exec(empty, empty);
    };
    index.html unhandled rejections tracking support, NodeJS Promise without it fails @@species test
    return (isNode || typeof PromiseRejectionEvent == 'function')
      && promise.then(empty) instanceof FakePromise
      index.html v8 6.6 (Node 10 and Chrome 66) have a bug with resolving custom thenables
      index.html https://bugs.chromium.org/p/chromium/issues/detail?id=830565
      index.html we can't detect it synchronously, so just check versions
      && v8.indexOf('6.6') !== 0
...
var notify = function (promise, isReject) {
  ...
  microtask(function () {
      ...
      try {
        if (handler) {
          ...
          if (handler === true) result = value;
            ...
            result = handler(value); index.html may throw
            if (domain) {
              domain.exit();
              exited = true;
            }
    ...
    while (chain.length > i) run(chain[i++]); index.html variable length - can't use forEach
    promise._c = [];
    promise._n = false;
...
var onUnhandled = function (promise) {
  task.call(global, function () {
    ...
    if (unhandled) {
      ...
      index.html Browsers should not trigger `rejectionHandled` event if it was handled here, NodeJS - should
...
var $reject = function (value) {
  ...
  promise._d = true;
  promise = promise._w || promise; index.html unwrap
  promise._v = value;
  promise._s = 2;
...
var $resolve = function (value) {
  ...
  try {
    ...
    if (then = isThenable(value)) {
      microtask(function () {
        var wrapper = { _w: promise, _d: false }; index.html wrap
        try {
    ...
    $reject.call({ _w: promise, _d: false }, e); index.html wrap
  }
};

index.html constructor polyfill
if (!USE_NATIVE) {
  index.html 25.4.3.1 Promise(executor)
  ...
  Internal = function Promise(executor) {
    this._c = [];             index.html <- awaiting reactions
    this._a = undefined;      index.html <- checked in isUnhandled reactions
    this._s = 0;              index.html <- state
    this._d = false;          index.html <- done
    this._v = undefined;      index.html <- value
    this._h = 0;              index.html <- rejection state, 0 - default, 1 - handled, 2 - unhandled
    this._n = false;          index.html <- notify
  };
  Internal.prototype = __webpack_require__(242)($Promise.prototype, {
    index.html 25.4.5.3 Promise.prototype.then(onFulfilled, onRejected)
    ...
    index.html 25.4.5.1 Promise.prototype.catch(onRejected)
...
$export($export.S + $export.F * !USE_NATIVE, PROMISE, {
  index.html 25.4.4.5 Promise.reject(r)
...
$export($export.S + $export.F * (LIBRARY || !USE_NATIVE), PROMISE, {
  index.html 25.4.4.6 Promise.resolve(x)
...
$export($export.S + $export.F * !(USE_NATIVE && __webpack_require__(189)(function (iter) {
  ...
  index.html 25.4.4.1 Promise.all(iterable)
  ...
  index.html 25.4.4.4 Promise.race(iterable)
...
var exports = module.exports = function (iterable, entries, fn, that, ITERATOR) {
  ...
  index.html fast case for arrays with default iterator
...
var run = function () {
  var id = +this;
  index.html eslint-disable-next-line no-prototype-builtins
...
index.html Node.js 0.9+ & IE10+ has setImmediate, otherwise:
if (!setTask || !clearTask) {
  setTask = function setImmediate(fn) {
    ...
    queue[++counter] = function () {
      index.html eslint-disable-next-line no-new-func
  ...
  index.html Node.js 0.8-
  if (__webpack_require__(57)(process) == 'process') {
    defer = function (id) {
      process.nextTick(ctx(run, id, 1));
    };
  index.html Sphere (JS game engine) Dispatch API
  } else if (Dispatch && Dispatch.now) {
    defer = function (id) {
      Dispatch.now(ctx(run, id, 1));
    };
  index.html Browsers with MessageChannel, includes WebWorkers
  } else if (MessageChannel) {
    channel = new MessageChannel();
    port = channel.port2;
    channel.port1.onmessage = listener;
    defer = ctx(port.postMessage, port, 1);
  index.html Browsers with postMessage, skip WebWorkers
  index.html IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
...
__webpack_require__(28) && $export($export.P + __webpack_require__(299), 'Object', {
...
module.exports = __webpack_require__(44) || !__webpack_require__(29)(function () {
  var K = Math.random();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _multiselect_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22);
