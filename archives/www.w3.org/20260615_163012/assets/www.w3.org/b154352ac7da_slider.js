...
const translate = {
  'translations': {
    ...
    'ja': {
      'admin': 'ã¢ããã³',
      'anchor': '__anchor',
      'backToMainMenu': 'ã¡ã¤ã³ã¡ãã¥ã¼ã«æ»ã',
      'cancelReply': 'è¿ä¿¡ãã­ã£ã³ã»ã«',
      'controlsDescription': 'ã³ã³ãã­ã¼ã«ã®èª¬æ',
      'logged-in': 'ã­ã°ã¤ã³æ¸ã¿',
      'logout': 'ã­ã°ã¢ã¦ã',
      'member-site': 'ã¡ã³ãã¼ãµã¤ã',
      'menu': 'ã¡ãã¥ã¼',
      'my-account': 'ãã¤ã¢ã«ã¦ã³ã',
      'my-calendar': 'ãã¤ã«ã¬ã³ãã¼',
      'my-organization': 'ç§ã®çµç¹',
      'nextSlide': 'æ¬¡ã®ã¹ã©ã¤ã',
      'previousSlide': 'åã®ã¹ã©ã¤ã',
      'sign-in': 'ãµã¤ã³ã¤ã³',
      'sliderDescription': 'ã¹ã©ã¤ãã¼ã®èª¬æ',
      'slideText': 'ã¹ã©ã¤ã {x} / {y}',
      'team-site': 'ãã¼ã ãµã¤ã'
    },
    'pt-br': {
      'admin': '__admin',
      'backToMainMenu': '__backToMainMenu',
    ...
    'zh-hans': {
      'admin': 'ç®¡ç',
      'anchor': '__anchor',
      'backToMainMenu': 'è¿åä¸»ç®å½',
      'cancelReply': 'åæ¶åå¤',
      'controlsDescription': 'è½®æ­å¾æ§ä»¶',
      'logged-in': 'å·²ç»å½',
      'logout': 'ç»åº',
      'member-site': 'ä¼åé¡µé¢',
      'menu': 'ç®å½',
      'my-account': 'æçè´¦å·',
      'my-calendar': 'æçæ¥å',
      'my-organization': 'ææå¨çç»ç»',
      'nextSlide': 'ä¸ä¸é¡µ',
      'previousSlide': 'ä¸ä¸é¡µ',
      'sign-in': 'ç»å½',
      'sliderDescription': 'è½®æ­å¾',
      'slideText': 'ç¬¬{x}/{y}é¡µ',
      'team-site': 'åå·¥é¡µé¢'
    }
  },
